...
class GeoArtModelV0(pl.LightningModule):
    ...
    def test_step(self, data, batch_idx):
        ...
        # scene = trimesh.Scene()
        # 
        # scene.add_geometry(static_part_simp)
        # scene.add_geometry(mobile_part_simp)
        # add_r_joint_to_scene(
        #     scene, joint_axis_pred, pivot_point_pred, 1.0, recenter=True
        # )
        # scene.export("/home/exx/Downloads/temp.ply")
